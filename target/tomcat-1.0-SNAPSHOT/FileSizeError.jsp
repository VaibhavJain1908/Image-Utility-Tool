...
<p class="wrong" >ERROR: File Size Must not exceed 1 MB and Total Files Size must not Exceed 10 MB</p>
<br>
<br>
        ...
        <div>
            <td>
                <form action="edit.jsp">
                    ...
                    <label for="edit"><img class="action" src="/images/edit.png" alt="edit"></label>
                    <input id="edit" style="visibility:hidden" type="submit">
                </form>

                <form action="cancel.jsp">
                    <input type="hidden" name="imgID" value="<%=image.getId()%>">
                    <label for="cancel"><img class="action cancel" src="/images/cancel.png" alt="cancel"></label>
                    <input id="cancel" style="visibility:hidden" type="submit">
                </form>
            </td>
        </div>
